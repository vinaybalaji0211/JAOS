...
class ReasoningRequest:
    """Represents a validated reasoning request."""
    ...
    required_output_type: str = "structured"

    risk_policy: str = "safe"
    ...
    def __post_init__(self) -> None:
        """Validate and normalize the reasoning request."""
        ...
        if (
            self.context_bundle.request_id
